          ...
          <div class="col-md-8">
            <div class="card-body">
              <p class="card-text"><strong>Name :</strong>
                {{ $student->name }}</p>
              <p class="card-text"><strong>Kelas :</strong>
                {{ $student->kelas }}</p>
              <p class="card-text"><strong>Alamat :</strong>
                {{ $student->alamat }}</p>
              <p class="card-text"><strong>Suhu Tubuh :</strong>
                {{ $student->suhu }}</p>
              <p class="card-text"><strong>Vaksin Ke :</strong>
                {{ $student->vaksin }}</p>
              <p class="card-text"><strong>Sudah Pernah Kena Covid? :</strong>
                {{ $student->covid }}</p>
